...
I too feel that I'm no longer getting what I pay for, and found myself turning back to DVDs, CDs and vinyl records. It both helps to show my devotion to that specific piece of media, as well as gives me a license to consume said media whenever I want, forever.
...
That's when I thought of it, what if instead of buying a game outright, do-it-yourself kit. Similar to how table top role playing games will have multiple large books containing rules to play the game, I thought I might be able to fit instructions to make a digital game in a book.
